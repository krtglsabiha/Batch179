...
public class C02Maps {
    ...
    public static void main(String[] args) {
        ...
        //Example: Get the total number of characters in student names
        ...
        //Example: Find average age of the students.
      ...
      double sumOfAge=0;
        ...
        //Example:Find the sum of the num of character and the age for every entry
