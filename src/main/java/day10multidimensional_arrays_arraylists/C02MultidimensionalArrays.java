...
public class C02MultidimensionalArrays {
    ...
    System.out.println(Arrays.deepToString(a)); // [[2, 3], [5, 2], [7, 9]]
        ...
        //Example: Type code to find the total number of elements in a multidimensional array
        ...
        //Example:Print the elements has "a" in it from a multidimensional array
        ...
        //Example : Type code to find the maximum and minimum elements in a two-dimensional integer array
        ...
        //Example:Type code to convert a multi dimensional array to a one dimensional array
