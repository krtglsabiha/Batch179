package day23iterators_lambda;
    ...
    /*
    1)Lambda is "Functional Programming", the programming we learned so far is "Structure Programming"
    2)"Functional Programming" focus on "What to do" more than "How to do"
       "Structure Programming" spends too much time on "How to do"
     */
...
public class C05Lambda {
    ...
    //Example:Create a method to print all elements on the console in the same line with a space between them
    //1.way:
    ...
    public  static void printCubeEvens(List<Integer>list){
