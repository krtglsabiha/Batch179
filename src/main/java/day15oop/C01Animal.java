package day15oop;
       ...
       1)Java uses constructors from parent to child because without having parent we cannOt have child.
       2)Every constructor has super() in the first line of the constructor of body.
         super() is invisible as default,if you want you can make it invisible to increase readability.
       ...
       4)this(); is for calling constructors from the same class.
        ...
        7)If you have variables with the same name in inheritance.
          The value of variable will be selected from the class as data type of the object.
