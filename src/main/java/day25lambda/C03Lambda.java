...
public class C03Lambda {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Files.lines(Paths.get("src/main/java/day25lambda/MyTextFile.txt")).
        ...
        Files.
                ...
                filter(t->t.contains("Java")).forEach(System.out::println);
        ...
        //Print the words and with "s", distinctly, in uppercase and in alphabetical order.
        Files.
                lines(Paths.get("src/main/java/day25lambda/MyTextFile.txt")).
                map(t->t.split(" ")).
                flatMap(Arrays::stream).
